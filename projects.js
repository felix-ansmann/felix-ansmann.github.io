...
const PROJECTS = [
  ...
  {
    title: "Notes on the Political Economy of Frontier AI",
    venue: "2026 – Encounters Bookspace",
    type: "Other",
    description: "Talk on AI, data, and the ways in which AI companies are dependent on the appropriation of human intelligence. Part of The Language of Prediction with artist Sheung Yiu presented by <a href='https://wma.hk/' target='_blank'>WMA</a>.",
    images: [
